        ...
        <article>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>Open University, UK – Certificat Profesional în Management</li>
                    <li>CIPD, UK – Certificate in Personnel Practice</li>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>Coaching</li>
                    <li>Mentorat</li>
                    <li>Antrenament 1 la 1, cu feedback aplicat și exemple concrete</li>
                </ul>
            </section>
